  ...
  return (
    <div className="space-y-6 max-w-5xl font-sans">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-[#000666] text-[22px]">tune</span>
          ...
          <p className="text-xs text-slate-500 mt-1 font-medium">
            Manage institutional scrapers, sync frequencies, notification preferences, and run live diagnostics.
          </p>
        </div>
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 text-xs font-bold flex items-center gap-2 transition-all shrink-0 self-start sm:self-auto cursor-pointer disabled:opacity-50"
        >
          <span className={`material-symbols-outlined text-[16px] text-[#000666] ${isRunningDiagnostics ? 'animate-spin' : ''}`}>
            health_and_safety
          </span>
